...
const DonationContainer = props => {
    return (
        <div className="donation">
            ...
            <DonationForm onSubmit={props.onSubmit} onChange={props.onChange} max={props.max} donationFormClassName={props.donationFormClassName} donationButtonClassName={props.donationButtonClassName}/>
